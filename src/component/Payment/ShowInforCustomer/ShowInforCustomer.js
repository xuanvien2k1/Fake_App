function ShowInforCustomer({payment,changeFullName,changePhone, changeNumberHome, changeCity, city, district, changeDistrict, village, disableDistrict, disableVillage, changeVillage}) {
            ...
            return (
                ...
                <div className="form-information">
                    <div className="input-person">
                        <input placeholder="Name..." onChange={changeFullName} value={p.fullName}/>
                        <input placeholder="Number..." onChange={changePhone} value={p.phone}/>
                    </div>
                    ...
                    <input className="numberhome" placeholder="Home..." onChange={changeNumberHome} value={p.numberHome}/>
                </div>
            </div>
            );
        })
